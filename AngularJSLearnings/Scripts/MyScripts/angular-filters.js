var myApp = angular.module("myModule", [])
    .controller("myController", function ($scope) {
        var employees = [
            { name: "Ravi", dob: new Date("January 25, 1973"), gender: "Male", salary: "240000" },
            ...
            { name: "RaviM", dob: new Date("February 26, 1979"), gender: "Male", salary: "40000" },
            { name: "Ramesh", dob: new Date("March 26, 1979"), gender: "Male", salary: "240000" },
            { name: "Padmakumar", dob: new Date("April 26, 1980"), gender: "Male", salary: "200000" }
        ];
